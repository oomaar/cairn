  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
      <div className="flex min-h-0 flex-1 overflow-y-auto p-5">
        <div className="w-full grid gap-4 grid-cols-1 lg:grid-cols-[1fr_1fr_300px] lg:grid-rows-[auto_auto_auto] items-start">
          {/* Expedition Status Board — spans 2 cols on desktop */}
          <div className="lg:col-span-2">
            <CommandExpeditionBoard />
          </div>

          {/* Conditions by Range — right sidebar spans 3 rows on desktop */}
          ...
          {/* Operations Feed — full width third row (left 2 cols) */}
          <div className="lg:col-span-2">
